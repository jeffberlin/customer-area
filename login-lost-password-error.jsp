        ...
        <div class="row justify-content-center">
          <div class="box-style">
            <div class="customer-login-box" style="background-color: rgba(255, 255, 255, 0.3);">
              ...
              <p style="font-size: .9rem;">If all information was correct and you still have received this error page, the system may be temporarily unavailable. Please wait 60 minutes and <a href="https://customers.bmtmicro.com/">try again</a>.</p>
