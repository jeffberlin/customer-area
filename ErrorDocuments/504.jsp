        ...
        <div class="row justify-content-center">
          <div class="box-style" style="max-width: 650px;">
            <div class="customer-login-box" style="background-color: rgba(255, 255, 255, 0.3); padding: 1rem 1.5rem;">
              ...
              <p>The server has timed out and is no longer processing your request. This is most likely temporary and you should retry the operation that caused this error in a few moments. If you continue to get this error message please email <a href="mailto:webmaster@bmtmicro.com">webmaster@bmtmicro.com</a> so we may investigate the issue.</p>
