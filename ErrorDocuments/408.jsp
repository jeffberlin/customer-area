        ...
        <div class="row justify-content-center">
          <div class="box-style" style="max-width: 650px;">
            <div class="customer-login-box" style="background-color: rgba(255, 255, 255, 0.3); padding: 1rem 1.5rem;">
              ...
              <p>Your browser has timed out. Please retry the operation that generated this message in a few moments.Please email <a href="mailto:webmaster@bmtmicro.com">webmaster@bmtmicro.com</a> if you continue to receive this error.</p>
