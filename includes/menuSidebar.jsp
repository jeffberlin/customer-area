...
<div class="col-lg-2">
  <aside class="sidebar" role="complementary">
    <img src='<c:url value="https://customers-new.bmtmicro.com/images/bmt-micro-logo-new-min.png"></c:url>' alt="BMT Micro, Inc. logo">
    <div class="home-nav">
      <a class="sidebar-group" href="https://customers-new.bmtmicro.com/main.jsp">Home</a>
    </div> <!-- /.home-nav -->
    <div class="home-nav">
      <a class="sidebar-group" href="https://customers-new.bmtmicro.com/my-account.jsp">My Account</a>
    </div> <!-- /.home-nav -->
    <div class="dropright">
    ...
    <div class="home-nav">
      <a class="sidebar-group" href="https://customers-new.bmtmicro.com/contactstart.html">Contact</a>
    </div> <!-- /.home-nav -->
    <div class="home-nav">
      <a class="sidebar-group" href="https://customers-new.bmtmicro.com/login.jsp">Log Out</a>
    </div> <!-- /.home-nav -->
  </aside>
</div> <!-- /.col-lg-2 -->
