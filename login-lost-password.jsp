        ...
        <div class="row justify-content-center">
          <div class="box-style">
            <div class="customer-login-box" style="background-color: rgba(255, 255, 255, 0.3);">
              <form action="https://customers.bmtmicro.com/servlets/Customers.ResetPassword" method="post">
                <input type="hidden" name="NEXT_PAGE" value="https://customers.bmtmicro.com/login-reset-link-sent.jsp">
                <input type="hidden" name="RESET_PAGE" value="https://customers.bmtmicro.com/login-reset-password.jsp">
                <input type="hidden" name="ERROR_PAGE" value="https://customers.bmtmicro.com/login-lost-password-error.jsp">
